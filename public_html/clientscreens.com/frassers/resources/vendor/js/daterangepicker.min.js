...
!(function (t, e) {
  ...
  var a = function (a, i, s) {
    if (
      ...
      (this.singleDatePickerWithMulti = !1),
    ...
    if (
      ...
      'boolean' == typeof i.singleDatePickerWithMulti &&
        ((this.singleDatePickerWithMulti = i.singleDatePickerWithMulti),
        this.singleDatePickerWithMulti &&
    ...
    (a.prototype = {
      ...
      clickDate: function (t) {
        if (e(t.target).hasClass('available')) {
          ...
          if (this.singleDatePickerWithMulti) {
          ...
          this.updateView(), this.showCalendars(), t.stopPropagation();
        }
      },
